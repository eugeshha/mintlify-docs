---
title: 'Редактирование и превью'
description: 'Как локально править и просматривать эту доку'
---

Эта документация собрана на [Mintlify](https://mintlify.com). Ниже — как запустить превью локально и проверять ссылки при добавлении новых страниц.

<Info>
  **Нужно**: Node.js 19+, папка с `docs.json` (корень этой доки).
</Info>

Установка и запуск превью.
